...
//	}
	...
	public void notify(DataCollector col, Event ev) {
		System.out.println(testExpS + " - " + ev.client.deltaSpawn + " : " + testExpP + " - " + ev.client.deltaProcess);
		...
		System.out.println("sim end"+ simlationEnd + "end time"+ time);
		if(simlationEnd <= time){
			col.simulation.interrupt();
			finished = true;
			}
